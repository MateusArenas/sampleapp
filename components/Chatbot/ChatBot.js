        ...
        >
          ...
          >
            {/* <View style={{ flex: 1, alignItems: 'center', padding: 24, marginTop: 24, marginBottom: 24 }}>
              <View style={{ width: 120, height: 120, backgroundColor: '#8257e6', borderRadius: 120, borderWidth: 1, borderColor: "rgba(0,0,0,.05)",  }}>
              ...
              <TouchableOpacity onPress={() => Linking.openURL("https://www.redecredauto.com.br/portal/")}>
                <Text style={{ fontWeight: '500', fontSize: 12, color: '#8257e6' }}>redecredauto.com</Text>
              </TouchableOpacity>
